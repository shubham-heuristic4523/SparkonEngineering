...
class BuyerPurchaseOrderController extends Controller
{
    ...
    $NoOfOrder=count($Buyer_Purchase_Order_List);
        ...
        return view('BuyerPurchaseOrderMasterList', compact('Buyer_Purchase_Order_List','CheckForm','job_status_id','NoOfOrder','total_value','total_qty','open_qty','shipped_qty'));
     }
...
public function SalesOrderCancelled()
    ...
    ");
        ...
        // $query = end($query);
        // dd($query);
      return view('OpenSalesOrderDashboard', compact('OpenOrderList','CheckForm','job_status_id','NoOfOrderc','total_valuec','total_qtyc','open_qtyc','shipped_qtyc'));
        ...
        public function BuyerOpenSalesOrderDashboard()
    {
        ...
        // $query = end($query);
        // dd($query);
      return view('BuyerOpenSalesOrderDashboard', compact('OpenOrderList','CheckForm','job_status_id','NoOfOrderc','total_valuec','total_qtyc','open_qtyc','shipped_qtyc'));
         ...
         public function SalesOrderCostingBOMStatusDashboard()
    {
        ...
        // $query = end($query);
        // dd($query);
      return view('SalesOrderCostingBOMStatusDashboard', compact('BOMCostingStatusList','CheckForm','job_status_id','NoOfOrderc','total_valuec','total_qtyc','open_qtyc','shipped_qtyc'));
          ...
          public function CostingOHPDashboard()
    {
        ...
        // $query = end($query);
        // dd($query);
      return view('CostingOHPDashboard', compact('BOMCostingStatusList','CheckForm','job_status_id','NoOfOrderc','total_valuec','total_qtyc','open_qtyc','shipped_qtyc'));
    ...
    $NoOfOrderc=count($Buyer_Purchase_Order_List);
        ...
        return view('OpenSalesOrderDetailDashboard', compact('Buyer_Purchase_Order_List','CheckForm','job_status_id','NoOfOrderc','total_valuec','total_qtyc','open_qtyc','shipped_qtyc'));
    ...
    $NoOfOrderc=count($Buyer_Purchase_Order_List);
        ...
        return view('OpenSalesOrderMonthDetailDashboard', compact('Buyer_Purchase_Order_List','ShipmentMonth','CheckForm','job_status_id','NoOfOrderc','total_valuec','total_qtyc','open_qtyc','shipped_qtyc'));
    ...
    $NoOfOrderc=count($Buyer_Purchase_Order_List);
        ...
        return view('CostingVSBudgetDashboard', compact('Buyer_Purchase_Order_List','CheckForm','job_status_id','NoOfOrderc','total_valuec','total_qtyc','open_qtyc','shipped_qtyc'));
    ...
    $NoOfOrderc=count($Buyer_Purchase_Order_List);
        ...
        return view('TotalSalesOrderDetailDashboard', compact('Buyer_Purchase_Order_List','CheckForm','job_status_id','NoOfOrderc','total_valuec','total_qtyc','open_qtyc','shipped_qtyc'));
   ...
   (select  ifnull(sum(size_qty_total),0)  from cut_panel_grn_detail where cut_panel_grn_detail.color_id=buyer_purchase_order_detail.color_id and cut_panel_grn_detail.sales_order_no=buyer_purchse_order_master.tr_code) as total_cutting_qty,
    ...
    ");
        ...
        // $query = end($query);
        // dd($query); 
      return view('DailyProductionDetailDashboard', compact('ProductionOrderDetailList','CheckForm','job_status_id'));
...
ifnull( (vendor_work_order_detail.size_qty_total),0) as order_qty,
    ...
    ");
        ...
        // $query = end($query);
        // dd($query); 
      return view('OrderProgressDetailDashboard', compact('ProductionOrderDetailList','CheckForm','job_status_id'));
...
ifnull( (vendor_purchase_order_detail.size_qty_total),0) as order_qty,
    ...
    ");
        ...
        // $query = end($query);
        // dd($query); 
      return view('OrderProgressFinishingDetailDashboard', compact('ProductionOrderDetailList','CheckForm','job_status_id'));
...
ifnull( (vendor_purchase_order_detail.size_qty_total),0) as order_qty,
    ...
    ");
        ...
        // $query = end($query);
        // dd($query); 
      return view('OrderProgressPackingDetailDashboard', compact('ProductionOrderDetailList','CheckForm','job_status_id'));
