...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0 font-size-18">Enquiry Type Master</h4>

            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item"><a href="javascript: void(0);">Forms</a></li>
                    <li class="breadcrumb-item active">Enquiry Type Master</li>
                </ol>
            </div>
    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                ...
                @else
                <form action="{{route('Enquiry.store')}}" method="POST" id="EnquiryModelFrm">
                    @csrf
                    <div class="row">
                        <div class="col-md-3">
                            <div class="mb-3">
                                <label for="formrow-email-input" class="form-label">Enquiry Name<span
                                        class="label-required">*</span></label>
                                <input type="text" name="enquiry_name" class="form-control" id="formrow-email-input" required>
