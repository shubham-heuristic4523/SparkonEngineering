            ...
            <div class="card-body">
                ...
                <form action="{{ route('User_Master.update',$permissions) }}" method="POST" id="UserManagementFrm">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="formrow-inputState" class="form-label">Sub Company</label>
                                <select name="sub_company_id" id="sub_company_id"
                                    ...
                                    @foreach($branchlist as $rowbranchlist)
                                    <option value="{{ $rowbranchlist->sub_company_id }}"
                                        {{ $rowbranchlist->sub_company_id == $permissions->sub_company_id ? 'selected="selected"' : '' }}>
                                        {{ $rowbranchlist->sub_company_name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select name="w_id" class="form-select" id="w_id" required>
                                    <option value="">--- Select Employee ---</option>
                                    @foreach($workerlist as $row)
                                    {
                                    <option value="{{ $row->employeeCode }}"
                                        {{ $row->employeeCode == $permissions->w_id ? 'selected="selected"' : '' }}>
                                        {{ $row->fullName }}</option>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="formrow-inputState" class="form-label">Vendor<span
                                        class="label-required">*</span></label>
                                <select name="vendorId" class="form-select" id="vendorId" required>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="contact" class="form-control" id="formrow-email-input"
                ...
                <form action="{{route('User_Master.store')}}" method="POST" id="UserManagementFrm">
                    ...
                    <div class="col-md-6">
                            <div class="mb-3">
                                <label for="formrow-inputState" class="form-label">Sub Company</label><span
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select name="w_id" class="form-select" id="w_id" required>
                                    ...
                                    <!-- @foreach($workerlist as $row)
                                    {
                                    <option value="{{ $row->employeeCode }}">{{ $row->fullName }}</option>
