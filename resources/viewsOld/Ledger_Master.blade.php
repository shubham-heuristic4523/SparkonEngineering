               ...
               <div class="row">
                  ...
                  <div class="col-md-4">
                     <div class="mb-3">
                        ...
                        <textarea rows="1"  class="form-control" cols="20" name="address" id="address">{{ $Ledger->address }}</textarea>
                     </div>
                  </div>
                  <div class="col-md-2">
                     <div class="mb-3">
                     ...
                     <table id="footable_3" class="table  table-bordered table-striped m-b-0  footable_3">
                        ...
                        <tbody>
                           ...
                           <tr>
                              ...
                              <td>
                              <input type="hidden"   name="sr_no[]"  class="form-control" id="sr_no" value="0">
            ...
            <form action="{{route('Ledger.store')}}" method="POST">
               ...
               <div class="row">
                  ...
                  <div class="col-md-4">
                     <div class="mb-3">
                        <label for="address" class="form-label">Address</label>
                        <textarea rows="1"  class="form-control" cols="20" name="address" id="address"></textarea>
                     </div>
                  </div>
                  <div class="col-md-2">
                     <div class="mb-3">
