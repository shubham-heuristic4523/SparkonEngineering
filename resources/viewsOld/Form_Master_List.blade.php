...
@endif
    ...
    <a href="{{ route('Form.create') }}" class="btn btn-primary">Add New Record</a>
@else
                                         ...
                                         @if($CheckForm->edit_access==1)
                                             ...
                                             <td>
                                                ...
                                                @endif
                                                 ...
                                                 <td>
                                                    <a class="btn btn-outline-secondary btn-sm view" href="{{route('Form.show', $row->form_code)}}" title="View">
