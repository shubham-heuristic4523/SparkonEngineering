...
<div class="row">
   <div class="col-md-6">
      <!-- <a href="{{ Route('Expense.create') }}"><button type="buuton" class="btn btn-primary w-md">Add New Record</button></a> -->
          @if(isset($CheckForm) && $CheckForm->write_access == 1)
    <a href="{{ route('Expense.create') }}" class="btn btn-primary">Add New Record</a>
@else
            ...
            <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
               ...
               <tbody>
                  ...
                  <tr>
                     ...
                     <td>
                        <a class="btn btn-outline-secondary btn-sm edit" href="{{route('Expense.edit', $Expense->exp_id)}}" title="Edit">
