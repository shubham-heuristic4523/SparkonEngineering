                              ...
                              <tr>
                                  ...
                                  <td>
                                      <a class="btn btn-outline-secondary btn-sm edit"
                                          href="{{route('User_Management.edit', $row->userId)}}" title="Edit">
                                  ...
                                  <td>
                                      <a class="btn btn-outline-secondary btn-sm view"
                                          href="{{route('User_Management.show', $row->userId)}}" title="View">
                                  ...
                                  <td>
                                      ...
                                      <button class="btn   btn-sm delete DeleteRecord" data-placement="top" id=""
                                          ...
                                          data-route="{{route('User_Management.destroy', $row->userId )}}"
                                          title="Delete">
