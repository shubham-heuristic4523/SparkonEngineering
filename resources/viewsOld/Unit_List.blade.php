...
<div class="row mb-3">
   <div class="col-md-6">
      <a href="{{ route('Unit_Master.create') }}" class="btn btn-primary w-md">Add New Record</a>
   </div>
</div>
@endif
                  ...
                  <tr>
                     ...
                     <td>
                        <a class="btn btn-outline-secondary btn-sm edit"
                           href="{{ route('Unit_Master.edit', $unit->unit_id) }}"
                           title="Edit">
                     ...
                     <td>
                        <a class="btn btn-outline-secondary btn-sm"
                           href="{{ route('Unit_Master.show', $unit->unit_id) }}"
                           title="View">
                     ...
                     <td>
                        <button class="btn btn-outline-danger btn-sm delete"
                           ...
                           data-route="{{ route('Unit_Master.destroy', $unit->unit_id) }}"
                           title="Delete">
