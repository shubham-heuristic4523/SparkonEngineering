    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                ...
                @if(isset($State))
                <form action="{{ route('State.update',$State) }}" method="POST" id="StateFrm">
                    @method('put')
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="formrow-email-input" class="form-label">State Name<span
                                        class="label-required">*</span></label>
                    ...
                    <div>
                        ...
                        <a href="{{ route('State.index') }}" class="btn btn-danger w-md">Cancel</a>
                    </div>
                </form>

                @else
                <form action="{{route('State.store')}}" method="POST" id="StateFrm">
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
