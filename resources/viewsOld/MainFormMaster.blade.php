...
@if(isset($formFetch))
<form action="{{ route('MainForm.update',$formFetch->mainformId) }}" method="POST" id="updateform"
    ...
    <div class="row">
        <div class="col-xl-12 col-lg-12">
            <div class="card">
                <div class="card-body">
                    <div class="card-title">MainForm Master:</div>
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                <label class="form-label">Main Form</label>
                                <input type="text" name="mainformName" class="form-control" placeholder="Main Form"
                                    value="{{ $formFetch->mainformName }}" required="required">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="route_name" class="form-control" placeholder="Route Name"
                                    value="{{ $formFetch->route_name }}" required="required">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label class="form-label">Icon</label>
                                <input type="file" name="mainform_icon" class="form-control"
                                    value="{{ $formFetch->mainform_icon }}">
                            </div>
                        </div>
                    </div>
                ...
                <div class="card-footer text-right" style="text-align: right !important;">
                    ...
                    <a href="{{ route('MainForm.index') }}" class="btn  btn-danger">Cancel</a>
                </div>
            </div>
        </div>
    </div>
...
<form action="{{route('MainForm.store')}}" method="POST" id="insertform" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
						...
						<div class="col-md-3">
                            <div class="form-group">
                                <label class="form-label">Icon</label>
                                <input type="file" name="mainform_icon" class="form-control" required="required">
                            </div>
                        </div>
                    </div>
                </div>
