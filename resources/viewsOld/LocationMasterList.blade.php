      ...
      <div class="row">
          <div class="col-md-6">
              <!-- <a href="{{ Route('Location.create') }}"><button type="buuton" class="btn btn-primary w-md">Add New
                      Record</button></a> -->
                         @if(isset($CheckForm) && $CheckForm->write_access == 1)
    <a href="{{ route('Location.create') }}" class="btn btn-primary">Add New Record</a>
@else
                              ...
                              <tr>
                                  ...
                                  <td>
                                      <a class="btn btn-outline-secondary btn-sm edit"
                                          href="{{route('Location.edit', $row->loc_id)}}" title="Edit">
                                  ...
                                  <td>
                                      <a class="btn btn-outline-secondary btn-sm view"
                                          href="{{route('Location.show', $row->loc_id)}}" title="View">
                                  ...
                                  <td>
                                      <button class="btn btn-outline-secondary btn-sm delete" data-placement="top"
                                          id="DeleteRecord" data-token="{{ csrf_token() }}" data-id="{{ $row->loc_id }}"
                                          data-route="{{route('Location.destroy', $row->loc_id )}}" title="Delete">
