    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                ...
                @if(isset($unit))
                <form action="{{ route('UnitMaster.update', $unit->unit_id) }}" method="POST" id="UnitFrm">
                    @method('PUT')
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
                    ...
                    <div>
                        ...
                        <a href="{{ route('UnitMaster.index') }}" class="btn btn-danger w-md">Cancel</a>
                    </div>
                </form>
                @else
                <form action="{{ route('UnitMaster.store') }}" method="POST" id="UnitFrm">
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
