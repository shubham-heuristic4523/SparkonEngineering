      ...
      <div class="row">
          <div class="col-12">
              <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                  <h4 class="mb-sm-0 font-size-18">Firm List</h4>
      ...
      <div class="row">
          <div class="col-md-6">
              <!-- <a href="{{ Route('Firm.create') }}"><button type="buuton" class="btn btn-primary w-md">Add New
                      Record</button></a> -->
                         @if(isset($CheckForm) && $CheckForm->write_access == 1)
    <a href="{{ route('Firm.create') }}" class="btn btn-primary">Add New Record</a>
@else
                              ...
                              <tr>
                                  ...
                                  <td>
                                      <a class="btn btn-outline-secondary btn-sm edit"
                                          href="{{route('Firm.edit', $row->firm_id)}}" title="Edit">
                                          <i class="fas fa-pencil-alt"></i>
                                      </a>
                                  </td>
                                  <td>
                                      <a class="btn btn-outline-secondary btn-sm view"
                                          href="{{route('Firm.show', $row->firm_id)}}" title="View">
