...
<div class="page-header d-lg-flex d-block">
    <div class="page-leftheader">
        <h4 class="page-title">Sub Form</h4>
    </div>
    ...
    <div class="col-12">
        ...
        <div class="card">
            ...
            <div class="card-header border-bottom-0">
                <!-- <a href="{{ Route('SubForm.create') }}"><input type='button' class="btn btn-info mt-2"
                        value='Add New Record'></a> -->
                         @if(isset($CheckForm) && $CheckForm->write_access == 1)
    <a href="{{ route('SubForm.create') }}" class="btn btn-primary">Add New Record</a>
@else
                ...
                <div class="">
                    <div class="table-responsive">
                        <table id="file-datatable1" class="table table-bordered text-nowrap key-buttons border-bottom">
                            ...
                            <thead>
                                <tr>
                                    <th class="border-bottom-0">SubForm ID</th>
                                    <th class="border-bottom-0">SubForm Name</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{ $rowdata->subformId }}</td>
                                    <td>{{ $rowdata->subformName }}</td>
                                    <td>{{ $rowdata->mainformName }}</td>
                                    <td>{{ $rowdata->username }}</td>
                                    @if($CheckForm->edit_access==1)
                                    <td>
                                        <a class="btn btn-outline-secondary btn-sm edit"
                                            href="{{route('SubForm.edit', $rowdata->subformId)}}" title="Edit">
                                    ...
                                    <td>
                                        <button class="btn   btn-sm delete" data-placement="top" id="DeleteRecord"
                                            data-token="{{ csrf_token() }}" data-id="{{ $rowdata->subformId }}"
                                            data-route="{{route('SubForm.destroy', $rowdata->subformId )}}"
                                            title="Delete">
