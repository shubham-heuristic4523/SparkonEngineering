...
<div class="row mb-3">
   <div class="col-md-6">
      <a href="{{ route('UnitMaster.create') }}" class="btn btn-primary w-md">Add New Record</a>
   </div>
</div>
@endif
                  ...
                  <tr>
                     ...
                     <td>
                        <a class="btn btn-outline-secondary btn-sm edit"
                           href="{{ route('UnitMaster.edit', $unit->unit_id) }}"
                           title="Edit">
                     ...
                     <td>
                        <button class="btn btn-outline-danger btn-sm delete"
                           ...
                           data-route="{{ route('UnitMaster.destroy', $unit->unit_id) }}"
                           title="Delete">
