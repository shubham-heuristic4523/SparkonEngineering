...
<div class="row">
   <div class="col-12">
      <div class="page-title-box d-sm-flex align-KeyAreaMaster-center justify-content-between">
         <h4 class="mb-sm-0 font-size-18">Project Type List</h4>
...
<div class="row mb-3">
   <div class="col-md-6">
      <a href="{{ route('ProjectType.create') }}" class="btn btn-primary w-md">Add New Record</a>
   </div>
</div>
@endif
      ...
      <div class="card">
         <div class="card-body">
            <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
               ...
               <tbody>
                  @foreach($ProjectTypeMaster as $ProjectType)    
                  <tr>
                     ...
                     <td>
                        <a class="btn btn-outline-secondary btn-sm edit" 
                           href="{{ route('ProjectType.edit', $ProjectType->project_type_id) }}" 
                           title="Edit">
                     ...
                     <td>
                        <button class="btn btn-outline-danger btn-sm delete" 
                           ...
                           data-id="{{ $ProjectType->project_type_id }}"  
                           data-route="{{ route('ProjectType.destroy', $ProjectType->project_type_id) }}" 
                           title="Delete">
