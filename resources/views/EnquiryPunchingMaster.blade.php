    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{ route('EnquiryPunching.update', $EnquiryPunchingList->enquiry_id) }}" method="POST">
                    @method('PUT')
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="mb-3">
                                <label class="form-label">Enquiry Punching Number<span
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                <label for="date" class="form-label">Enquiry Date<span
                                        class="label-required">*</span></label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                <label for="date" class="form-label">Due Date<span
                                        class="label-required">*</span></label>
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                <label for="date" class="form-label">Submission Date<span
                                        class="label-required">*</span></label>
                                <input type="date" name="submission_date" class="form-control" id="submission_date"
                                    required value="{{ $EnquiryPunchingList->submission_date }}">
                            </div>
                        </div>

                        <div class="col-md-3">
                            <div class="mb-3">
                                <label for="formrow-inputState" class="form-label">Assigned To<span
                                        class="label-required">*</span></label>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <textarea name="enquiry_details" class="form-control" id="enquiry_details"
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                <label for="formrow-inputState" class="form-label">Status<span
                                        class="label-required">*</span></label>
                                <select name="stage_id" class="form-select" id="stage_id" required>
                                    ...
                                    <option value="{{ $row->stage_id }}"
                                        {{ $row->stage_id == $EnquiryPunchingList->stage_id ? 'selected="selected"' : '' }}>
                                        {{ $row->stage_name }}
                                    </option>
                        ...
                        <!-- <div class="col-md-3">
                            <div class="mb-3">
                                <label for="formrow-inputState" class="form-label">Stage<span
                                        class="label-required">*</span></label>
                                <select name="stage_id" class="form-select" id="stage_id" required>
                                    <option value="">--- Select Stage ---</option>
                                    @foreach($Stagelist as $row)
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                <label for="formrow-inputState" class="form-label">Lable<span
                                        class="label-required">*</span></label>
                                <select name="lable_id" class="form-select" id="lable_id" required>
                                    <option value="">--- Select Lable ---</option>
                                    @foreach($Lablelist as $row)
                                    {
                                    <option value="{{ $row->lable_id }}"
                                        {{ $row->lable_id == $EnquiryPunchingList->lable_id ? 'selected="selected"' : '' }}>
                                        {{ $row->lable_name }}
                                    </option>
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input type="text" name="reason" class="form-control" id="reason"
                                    value="{{ $EnquiryPunchingList->reason }}">
                            </div>
                        </div>
                         <div class="col-md-3">
                            <div class="mb-3">
                                <label for="document_link" class="form-label">Document Link<span
                                        class="label-required">*</span></label>
                                <input type="text" name="document_link" class="form-control" id="document_link" placeholder="Paste Link"
                                    value="{{ $EnquiryPunchingList->document_link }}">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <select name="lable_id" class="form-select" id="lable_id" required>
                                    ...
                                    @foreach($Lablelist as $row)
                                    {
                                    <option value="{{ $row->lable_id }}">{{ $row->lable_name }}</option>
                        ...
                        <div class="col-md-3">
                         ...
                         <div class="col-md-3">
                            <div class="mb-3">
                                <label for="document_link" class="form-label">Document Link<span
                                        class="label-required">*</span></label>
                                <input type="text" name="document_link" class="form-control" id="document_link"
                                placeholder="Paste Link" value="">
                            </div>
                        </div>
                    </div>
