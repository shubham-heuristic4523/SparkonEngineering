      ...
      <div class="row">
          <div class="col-md-6">
              <!-- <a href="{{ Route('District.create') }}"><button type="button"
                      class="btn btn-primary w-md float-right">Add New Record</button></a> -->

                         @if(isset($CheckForm) && $CheckForm->write_access == 1)
    <a href="{{ route('District.create') }}" class="btn btn-primary">Add New Record</a>
@else
                              ...
                              <tr>
                                  ...
                                  <td>
                                      <a class="btn btn-outline-secondary btn-sm edit"
                                          href="{{route('District.edit', $row->d_id )}}" title="Edit">
                                  ...
                                  <td>
                                      <a class="btn btn-outline-secondary btn-sm view"
                                          href="{{route('District.show', $row->d_id)}}" title="View">
                                  ...
                                  <td>
                                      <button class="btn btn-outline-secondary btn-sm delete" data-placement="top"
                                          id="DeleteRecord" data-token="{{ csrf_token() }}" data-id="{{ $row->d_id }}"
                                          data-route="{{route('District.destroy', $row->d_id )}}" title="Delete">
