...
<div class="row">
   <div class="col-xl-12">
      <div class="card">
         <div class="card-body">
            <h4 class="card-title mb-4">Employee Master</h4>
            @if ($errors->any())
            <div class="col-md-6">
            ...
            <form action="{{ route('EmployeeMaster.update',$WorkerList) }}" method="POST">
               ...
               <div class="row">
                  ...
                  <div class="col-md-3">
                     <div class="mb-3">
                        <label for="formrow-email-input" class="form-label">Employee Name</label>
               ...
               <div class="row">                  
                  ...
                  <div class="col-md-3">
                     <div class="mb-3">
                        <label for="w_particular" class="form-label">Employee Speciality</label>
