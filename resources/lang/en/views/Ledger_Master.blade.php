                ...
                <form action="{{ route('Ledger.update',$Ledger) }}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input type="text" name="ac_name" class="form-control" id="ac_name"
                                    value="{{ $Ledger->ac_name }}" required>
                                <input type="hidden" name="ac_code" class="form-control" id="ac_code"
                                    value="{{ $Ledger->ac_code }}" required>
                        ...
                        <div class="col-md-2">
                            <div class="mb-3">
                                ...
                                <input type="text" name="op_bal" class="form-control" id="formrow-email-input"
                                    value="{{ $Ledger->op_bal }}">
                                <input type="hidden" name="group_main" class="form-control" id="group_main"
                                    value="{{ $Ledger->group_main }}">
                            </div>
                        </div>
                        ...
                        <div class="col-sm-1">
                            ...
                            <div class="form-group">
                                <select id="op_dc" name="op_dc" class="form-control">
                                    <option value="Cr" {{ $Ledger->op_dc == 'Cr' ? 'selected="selected"' : '' }}>Cr
                                    </option>
                                    <option value="Dr" {{ $Ledger->op_dc == 'Dr' ? 'selected="selected"' : '' }}>Dr
                                    </option>
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" name="mobile" class="form-control" id="formrow-mobile-input"
                                    value="{{ $Ledger->mobile }}">
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input type="text" name="email" class="form-control" id="formrow-email-input"
                                    value="{{ $Ledger->email }}">
                        ...
                        <div class="col-md-2">
                            <div class="mb-3">
                                ...
                                <input type="text" name="pan_no" class="form-control" id="formrow-pan_no-input"
                                    maxlength="10" value="{{ $Ledger->pan_no }}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-2">
                            <div class="mb-3">
                                ...
                                <input type="text" name="gst_no" class="form-control" id="formrow-gst_no-input"
                                    maxlength="15" value="{{ $Ledger->gst_no }}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-2">
                            <div class="mb-3">
                                ...
                                <input type="text" name="adhar_no" class="form-control" id="formrow-adhar_no-input"
                                    value="{{ $Ledger->adhar_no }}">
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            ...
                            <div class="mb-3">
                                <input type="text" name="account_name" value="{{ $Ledger->account_name }}"
                                    class="form-control" />
                            </div>
                        </div>
                        ...
                        <div class="col-sm-2">
                            ...
                            <div class="mb-3">
                                <input type="text" name="ifsc_code" value="{{ $Ledger->ifsc_code }}"
                                    class="form-control" />
                            </div>
                        </div>
                        <div class="col-sm-3">
                            ...
                            <div class="mb-3">
                                <input type="text" name="tds_type" class="form-control"
                                    value="{{ $Ledger->tds_type }}" />
                            </div>
                        </div>
                        ...
                        <div class="col-sm-2">
                            ...
                            <div class="form-group">
                                <input type="number" step="0.01" name="tds_per" value="{{ $Ledger->tds_per }}"
                                    class="form-control" placeholder="Enter TDS % Here..." />
                            </div>
                        </div>
                    ...
                    <div class="table-wrap">
                        <div class="table-responsive">
                            <input type="number" value="{{ count($LedgerDetailList) }}" name="cntrr" id="cntrr"
                            ...
                            <table id="footable_3" class="table  table-bordered table-striped m-b-0  footable_3">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <input type="text" name="id[]" class="form-control" id="id"
                                                value="@php echo $no; @endphp" style="width:50px;" readOnly>
                                        </td>
                                        <td>
                                            <input type="hidden" name="sr_no[]" class="form-control" id="sr_no"
                                                value="{{ $List->sr_no }}">
                                            <input type="text" name="site_code[]" class="form-control" id="site_code"
                                                value="{{ $List->site_code }}">
                                        </td>
                                        <td>
                                            <input type="text" name="gst_nos[]" class="form-control" id="gst_nos[]"
                                                maxlength="15" value="{{ $List->gst_no }}">
                                        </td>
                                        <td>
                                            <input type="text" name="company_address[]" class="form-control"
                                                id="company_address[]" value="{{ $List->company_address }}">
                                        </td>
                                        <td>
                                            <input type="text" name="consignee_address[]" class="form-control"
                                                id="consignee_address[]" value="{{ $List->consignee_address }}">
                                        </td>
                                        <td><button type="button" onclick="insertcone(); "
                                                class="btn btn-warning pull-left">+</button> </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name="gst_nos[]" maxlength="15" class="form-control"
                                                id="gst_nos[]" value="">
                                        </td>
                                        <td>
                                            <input type="text" name="address[]" class="form-control" id="address[]"
                                        ...
                                        <td>
                                            <input type="text" name="consignee_address[]" class="form-control"
                                                id="consignee_address[]" value="">
                                        </td>
                                        <td><button type="button" onclick="insertcone(); "
                                                class="btn btn-warning pull-left">+</button><input type="button"
                                                class="btn btn-danger pull-left" onclick="deleteRowcone(this);"
                                                value="X"></td>
                ...
                <form action="{{route('Ledger.store')}}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-2">
                            <label for="formrow-inputState" class="form-label">TDS%</label>
                            <div class="form-group">
                                <input type="number" step="0.01" name="tds_per" value="0" class="form-control"
                                    placeholder="Enter TDS % Here..." />
                            </div>
                        </div>
                        <div class="col-sm-2">
                            <label for="formrow-inputState" class="form-label">Note</label>
