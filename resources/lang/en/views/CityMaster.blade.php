                            ...
                            <div class="mb-3">
                                ...
                                <select name="country_id" class="form-select" id="country_id" onChange="getState(this.value);">
                                    ...
                                    <option value="{{ $row->c_id }}"
                                        ...
                                        {{ $row->c_id == $CityList->country_id ? 'selected="selected"' : '' }}>{{ $row->c_name }}</option>
                            ...
                            <div class="mb-3">
                                ...
                                <select name="state_id" class="form-select" id="state_id" onChange="getDistrict(this.value);">
                                    ...
                                    <option value="{{ $row2->state_id }}"
                                        ...
                                        {{ $row2->state_id == $CityList->state_id ? 'selected="selected"' : '' }}>{{ $row2->state_name }}</option>
                            ...
                            <div class="mb-3">
                                ...
                                <select name="dist_id" class="form-select" id="dist_id" onChange="getTaluka(this.value);">
                                    ...
                                    <option value="{{ $row->d_id }}"
                                        ...
                                        {{ $row->d_id == $CityList->dist_id ? 'selected="selected"' : '' }}>{{ $row->d_name }}</option>
                            ...
                            <div class="mb-3">
                                ...
                                <select name="taluka_id" class="form-select" id="taluka_id">
                                    ...
                                    <option value="{{ $row->tal_id }}"
                                        {{ $row->tal_id == $CityList->taluka_id ? 'selected="selected"' : '' }}>{{ $row->taluka }}</option>
